$(function () {
    ...
    $(".graph .bar[data-day]").each(function () {
      ...
      switch (day) {
        case "sunday":
          $(this)
            .find(".bar-content")
            .css("height", (barH / 100) * data[day] + "px");
          break;
        case "monday":
          $(this)
            .find(".bar-content")
  ...
  function addUserToTable(data) {
    ...
    var ele =
      '<div class="users-item"><div class="table-item noflex">' +
      data["id"] +
      ...
      '</div><div class="table-item">' +
      (data["premium"] ? "Premium" : "Not Premium") +
      '<div class="user-edit-controls"><a href="#" class="table-edit-button">Edit</a></div></div></div>';
    table.append(ele);
  }
